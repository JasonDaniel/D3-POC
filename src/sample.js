function realTimeChartMulti() {
  ...
  var chart = function(s) {
    ...
    var nav = svg
      ...
      .attr(
        "transform",
        "translate (" + margin.left + "," + marginTopNav + ")"
      );
    ...
    var navG = nav.append("g").attr("class", "nav");
    ...
    yNav = d3.scale
      .ordinal()
      .domain(yDomain)
      .rangeRoundPoints([heightNav, 0], 1);
    ...
    var startTimeViewport = new Date(
      endTime.getTime() - (width / pixelsPerSecond) * 1000
    );
    var intervalViewport =
      endTimeViewport.getTime() - startTimeViewport.getTime();
